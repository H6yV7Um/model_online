...
class Client(Iface):
  ...
  def updateModel(self, param):
    ...
    Parameters:
     - param
    """
    self.send_updateModel(param)
    return self.recv_updateModel()

  def send_updateModel(self, param):
...
class Processor(Iface, TProcessor):
  ...
  def process_updateModel(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = updateModel_result()
    result.success = self._handler.updateModel(args.param)
...
class updateModel_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'param', (ServiceMonitorParam, ServiceMonitorParam.thrift_spec), None, ), # 1
  )
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.param = ServiceMonitorParam()
